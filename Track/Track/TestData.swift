...
//        firebaseHelper.createNewTrack(track)
        ...
        //test annotations
        let newAnnotation = Footprint(coordinate: coordinate, image: UIImage())
        ...
        let newAnnotationA = Footprint(coordinate: coordinateA, image: UIImage())
        ...
        let newAnnotationB = Footprint(coordinate: coordinateB, image: UIImage())
